...
public static class GameEvent
{
    ...
    //Plate
    public static UnityEvent OnTrayEmpty = new UnityEvent();

    //Tutoral
    public static UnityEvent ShowUnityEvent = new UnityEvent();

    //Fly to disk
    public static UnityEvent OnSpawnDisk = new UnityEvent();
    //Remove ice tray
    public static UnityEvent OnRemoveIce = new UnityEvent();
}
