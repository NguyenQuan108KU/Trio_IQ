...
if ( TRACE ) { TRACE( "CountdownTimer#OnTimeUp", this ); }
                ...
                if (UnityEngine.GameObject.op_Inequality(this.timeUpPanel, null)) {
                    ...
                    if (GameManager.Instance.isTimer) {
                        UnityEngine.Debug.Log$1(" Ending game.");
