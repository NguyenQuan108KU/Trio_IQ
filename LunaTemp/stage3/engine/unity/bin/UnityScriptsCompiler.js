...
if ( TRACE ) { TRACE( "EndCart_Lose#init", this ); }
                ...
                this.textFadeTime = 0.3;
                this.buttonDelay = 0.2;
                this.buttonScaleTime = 0.35;
                this.emojiDelay = 0.15;
                this.emojiFadeTime = 0.25;
                this.emojiScaleTime = 0.35;
            }
        },
        methods: {
...
if ( TRACE ) { TRACE( "EndCart_Lose#Awake", this ); }
                ...
                this.titleText.transform$1.localScale = new pc.Vec3( 1, 1, 1 ).clone().scale( 0.6 );
                this.emoji.transform.localScale = new pc.Vec3( 1, 1, 1 ).clone().scale( 0.6 );

                this.titleText.alpha = 1.0; // KHÔNG fade
...
if ( TRACE ) { TRACE( "EndCart_Lose#Show", this ); }
                ...
                DG.Tweening.DOVirtual.DelayedCall(0.01, Bridge.fn.bind(this, function () {
                    ...
                    // TEXT POP
                    DG.Tweening.TweenSettingsExtensions.Append(seq, DG.Tweening.TweenSettingsExtensions.SetEase$2(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.ShortcutExtensions.DOScale(this.titleText.transform$1, 1.05, 0.22), DG.Tweening.Ease.OutQuad));
                    DG.Tweening.TweenSettingsExtensions.Append(seq, DG.Tweening.ShortcutExtensions.DOScale(this.titleText.transform$1, 1.0, 0.1));

                    // EMOJI POP
                    DG.Tweening.TweenSettingsExtensions.AppendInterval(seq, 0.08);
                    //seq.Append(
                    //    emoji.transform
                    //        .DOScale(1f, 0.15f)
                    //        .SetEase(Ease.OutBack)
                    //);
                    DG.Tweening.TweenSettingsExtensions.Append(seq, DG.Tweening.ShortcutExtensions.DOScale(this.emoji.transform, 1.0, 0.12));

                    // BUTTON
                    DG.Tweening.TweenSettingsExtensions.AppendInterval(seq, 0.15);
...
if ( TRACE ) { TRACE( "EndCart_Lose#StartButtonPulse", this ); }
                ...
                this.buttonPulse = DG.Tweening.TweenSettingsExtensions.SetLoops$1(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.TweenSettingsExtensions.SetEase$2(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.ShortcutExtensions.DOScale(this.actionButton.transform, 1.5, 0.7), DG.Tweening.Ease.InOutQuad), -1, DG.Tweening.LoopType.Yoyo);
            },
...
if ( TRACE ) { TRACE( "EndCart_Lose#Hide", this ); }
                ...
                var seq = DG.Tweening.DOTween.Sequence();
                DG.Tweening.TweenSettingsExtensions.Append(seq, DG.Tweening.DOTweenModuleUI.DOFade$1(this.titleText, 0.0, 0.2));
                DG.Tweening.TweenSettingsExtensions.Join(seq, DG.Tweening.ShortcutExtensions.DOScale(this.actionButton.transform, 0.0, 0.2));

                if (UnityEngine.GameObject.op_Inequality(this.emoji, null)) {
                    var img = this.emoji.GetComponent(UnityEngine.UI.Image);
                    DG.Tweening.TweenSettingsExtensions.Join(seq, DG.Tweening.ShortcutExtensions.DOScale(this.emoji.transform, 0.0, 0.2));
                    if (UnityEngine.MonoBehaviour.op_Inequality(img, null)) {
                        DG.Tweening.TweenSettingsExtensions.Join(seq, DG.Tweening.DOTweenModuleUI.DOFade$2(img, 0.0, 0.2));
                    }
                }
...
if ( TRACE ) { TRACE( "TrayManager#ShowTutorialHint", this ); }
                ...
                if (this.isFirstTutorial) {
                    ...
                    if (UnityEngine.MonoBehaviour.op_Inequality(this.cachedTray, null) && UnityEngine.MonoBehaviour.op_Inequality(this.cachedSlot, null) && UnityEngine.MonoBehaviour.op_Inequality(this.cachedItem, null)) {
                        var fromSlot = this.cachedItem.GetComponentInParent(Slot);
                        if (UnityEngine.MonoBehaviour.op_Inequality(fromSlot, null)) {
                            TutorialManager.instance.ShowHandHint(fromSlot, this.cachedSlot, this.cachedItem);
                            return;
                        }
                    }
                }
                ...
                if (System.Nullable.hasValue(traySlot)) {
                    ...
                    if (UnityEngine.MonoBehaviour.op_Inequality(item, null)) {
                        var fromSlot1 = item.GetComponentInParent(Slot);
                        if (UnityEngine.MonoBehaviour.op_Inequality(fromSlot1, null)) {
                            TutorialManager.instance.ShowHandHint(fromSlot1, emptySlot, item);
                            return; // ✅ xong
                        }
                    }
                }
...
if ( TRACE ) { TRACE( "TutorialManager#HideHint", this ); }
    ...
    Bridge.define("UIButtonPulse", {
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "UIButtonPulse#init", this ); }
        ...
        methods: {
            /*UIButtonPulse.OnEnable start.*/
            OnEnable: function () {
if ( TRACE ) { TRACE( "UIButtonPulse#OnEnable", this ); }

                this.originalScale = this.transform.localScale.$clone();

                this.pulseTween = DG.Tweening.TweenSettingsExtensions.SetLoops$1(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.TweenSettingsExtensions.SetEase$2(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.ShortcutExtensions.DOScale$1(this.transform, this.originalScale.$clone().clone().scale( this.scaleUp ), this.duration), DG.Tweening.Ease.InOutQuad), -1, DG.Tweening.LoopType.Yoyo);
            },
            /*UIButtonPulse.OnEnable end.*/

            /*UIButtonPulse.OnDisable start.*/
            OnDisable: function () {
if ( TRACE ) { TRACE( "UIButtonPulse#OnDisable", this ); }
    ...
    /*UIButtonPulse start.*/
    $m("UIButtonPulse", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"OnDisable","t":8,"sn":"OnDisable","rt":$n[0].Void},{"a":1,"n":"OnEnable","t":8,"sn":"OnEnable","rt":$n[0].Void},{"a":2,"n":"duration","t":4,"rt":$n[0].Single,"sn":"duration","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"originalScale","t":4,"rt":$n[2].Vector3,"sn":"originalScale"},{"a":1,"n":"pulseTween","t":4,"rt":$n[3].Tween,"sn":"pulseTween"},{"at":[new UnityEngine.HeaderAttribute("Pulse Settings")],"a":2,"n":"scaleUp","t":4,"rt":$n[0].Single,"sn":"scaleUp","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}}]}; }, $n);
    /*UIButtonPulse end.*/
